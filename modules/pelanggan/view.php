...
$(document).ready(function(){
    ...
    var table = $('#tabel-pelanggan').DataTable( {
        ...
        "serverSide": true,                        //server-side perocessing
    ...
    "columnDefs": [
        ...
        'center' },
        { "targets": 1, "visible": false }, //kolom tersembunyi
        ...
        "render": function(data, type, row) { 
            ...
            class=\"btn btn-danger btn-sm btnHapus\" href=\"javascript:void(0);\"> <i class=\"fas fa-trash\"></i></a>"; 
            return btn; 
        } 
    }
], 
