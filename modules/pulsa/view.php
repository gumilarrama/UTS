<div class="content-header row mb-3">
    <div class="col-md-12">
        <h5>
            ...
            <a class="btn btn-info float-right" id="btnTambah" href="javascript:void(0);" data-toggle="modal"
            data-target="#modalPulsa" role="button"><i class="fas fa-plus"></i> Tambah </a>
        </h5>
    </div>
</div>
...
<div class="modal fade" id="modalPulsa" tabindex="-1" role="dialog" aria-labelledby="modalPulsa"
aria-hidden="true">
...
var table = $('#tabel-pulsa').DataTable( {
    ...
    // menampilkan data
    "columnDefs": [
        { "targets": 0, "data": null, "orderable": false, "searchable": false, "width": '30px', "className":
        'center' },
        {   "targets": 1, "width": '200px' },
        {   "targets": 2, "width": '80px', "className": 'right' },
        {   "targets": 3, "width": '80px', "className": 'right' },
        {   "targets": 4, "data": null, "orderable": false, "searchable": false, "width": '70px', "className":
            'center',
            // tombol ubah dan hapus
            "render": function(data, type, row) {
                var btn = "<a style=\"margin-right:7px\" title=\"Ubah\" class=\"btn btn-info btn-sm getUbah\"
                href=\"javascript:void(0);\"><i class=\"fas fa-edit\"></i></a><a title=\"Hapus\"
                class=\"btn btn-danger btn-sm btnHapus\" href=\"javascript:void(0);\">
